    ...
    <v-app-bar app elevate-on-scroll>
      ...
      <v-tooltip bottom open-delay="500" transition="scale-transition" origin="top center">
        <template v-slot:activator="{on}">
          <v-btn class="hidden-print-only" icon v-on="on" @click.stop.prevent="clickEvent();nextOrPrevious(false)">
      ...
      <v-tooltip bottom open-delay="500" transition="scale-transition" origin="top center">
        <template v-slot:activator="{on}">
          <v-btn class="hidden-print-only mr-2" icon v-on="on" @click.stop.prevent="clickEvent();nextOrPrevious(true)">
